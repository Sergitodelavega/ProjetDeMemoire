                    ...
                    <div class="card">
                        ...
                        <ul class="nav nav-tabs profile-tab" role="tablist">
                            <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab" href="#home"
                                    role="tab">Doctorants</a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#profile"
                                    role="tab">Directeurs</a> </li>

                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#home"
                                role="tab">Thèses terminées</a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#profile"
                                    role="tab">Laboratoire de recherche</a> 
                            </li>
                        </ul>
                        <!-- Tab panes -->
